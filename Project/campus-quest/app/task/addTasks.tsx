...
import { AddTasks } from "./taskMaster";
...
const Add_Task_Form = () => {
    ...
    const saveAllTasksToSupabase = (tasks: any[]) => {
        AddTasks(tasks)
    ...
    return (
        <>
            ...
            <Dialog open={firstOpen} onOpenChange={setFirstOpen}>
                <DialogTrigger onClick={() => setFirstOpen(true)} className="bg-blue-950 text-white text-[32px] font-semibold py-3 px-8 rounded-full shadow-md w-70 h-20">
                    Add Task
                </DialogTrigger>
